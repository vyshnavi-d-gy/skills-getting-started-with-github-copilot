...
activities = {
    ...
    "Basketball Club": {
        "description": "Improve basketball skills and compete in local tournaments",
        "schedule": "Wednesdays and Fridays, 5:00 PM - 6:30 PM",
        "max_participants": 16,
        "participants": ["liam@mergington.edu", "maya@mergington.edu"]
    },
    "Digital Art Studio": {
        "description": "Explore digital drawing, painting, and graphic design",
        "schedule": "Mondays, 4:00 PM - 5:30 PM",
        "max_participants": 15,
        "participants": ["nina@mergington.edu", "sam@mergington.edu"]
    },
    "Drama Workshop": {
        "description": "Develop acting skills through scenes, improv, and stagecraft",
        "schedule": "Thursdays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
        "participants": ["eva@mergington.edu", "ryan@mergington.edu"]
    },
    "Math Olympiad": {
        "description": "Practice problem solving and prepare for math competitions",
        "schedule": "Tuesdays, 4:30 PM - 6:00 PM",
        "max_participants": 12,
        "participants": ["chris@mergington.edu", "sophie@mergington.edu"]
    },
    "Science Research Group": {
        "description": "Work on experiments and research projects in biology and chemistry",
